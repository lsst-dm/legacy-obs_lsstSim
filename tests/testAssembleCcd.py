...
from lsst.obs.lsstSim import LsstSimAssembleCcdTask
...
class AssembleCcdTestCase(unittest.TestCase):
    ...
    def testCcdAssemble(self):
        ...
        assemblerConfig = LsstSimAssembleCcdTask.ConfigClass()
        assemblerConfig.doRenorm = False
        assembler = LsstSimAssembleCcdTask(config=assemblerConfig)
