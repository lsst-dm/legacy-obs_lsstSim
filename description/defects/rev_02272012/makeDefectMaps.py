...
fs = afwDetection.makeFootprintSet(im2, thresh)
x0 = []
y0 = [] 
width = []
height = []
...
col1 = pyfits.Column(name='x0', format='I4', array=numpy.array(x0))
col2 = pyfits.Column(name='y0', format='I4', array=numpy.array(y0))
col3 = pyfits.Column(name='height', format='I4', array=numpy.array(height))
col4 = pyfits.Column(name='width', format='I4', array=numpy.array(width))
